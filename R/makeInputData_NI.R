...
makeInputData_NI_N <- function(Trim_data, Spp_selection, convertNA = TRUE, save_allSppData = TRUE, returnData = FALSE){
  ...
  for(i in 1:length(input_Trim$EURINGCode)){
    write.csv2(input_Trim$data[[i]], paste0("NI_regions_files/Species_filesN/BMP_", input_Trim$EURINGCode[i],"_1_63_counts.csv"), row.names = FALSE)
  }
...
makeInputData_NI_S <- function(Trim_data, Spp_selection, convertNA = TRUE, save_allSppData = TRUE, returnData = FALSE){
  ...
  ## Save species-specific input files as per rtrim-shell format request
  for(i in 1:length(input_Trim$EURINGCode)){
    write.csv2(input_Trim$data[[i]], paste0("NI_regions_files/Species_filesS/BMP_", input_Trim$EURINGCode[i],"_1_63_counts.csv"), row.names = FALSE)
  }
...
makeInputData_NI_S_only <- function(Trim_data, Spp_selection, convertNA = TRUE, save_allSppData = TRUE, returnData = FALSE){
  ...
  ## Save species-specific input files as per rtrim-shell format request
  for(i in 1:length(input_Trim$EURINGCode)){
    write.csv2(input_Trim$data[[i]], paste0("NI_regions_files/Species_filesS_only/BMP_", input_Trim$EURINGCode[i],"_1_63_counts.csv"), row.names = FALSE)
  }
...
makeInputData_NI_Grouse <- function(Trim_data, Spp_selection, convertNA = TRUE, save_allSppData = TRUE, returnData = FALSE){
  ...
  ## Save species-specific input files as per rtrim-shell format request
  for(i in 1:length(input_Trim$EURINGCode)){
    write.csv2(input_Trim$data[[i]], paste0("NI_regions_files/Species_files_Grouse/BMP_", input_Trim$EURINGCode[i],"_1_63_counts.csv"), row.names = FALSE)
  }
...
makeInputData_NI_HeleNorge <- function(Trim_data, Spp_selection, convertNA = TRUE, save_allSppData = TRUE, returnData = FALSE){
  ...
  ## Save species-specific input files as per rtrim-shell format request
  for(i in 1:length(input_Trim$EURINGCode)){
    write.csv2(input_Trim$data[[i]], paste0("NI_regions_files/Species_files_HeleNorge/BMP_", input_Trim$EURINGCode[i],"_1_63_counts.csv"), row.names = FALSE)
  }
